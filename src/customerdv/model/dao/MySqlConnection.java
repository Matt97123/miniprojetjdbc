...
public class MySqlConnection {
    ...
    // il faut garder les paramètres ajoutés en fin d'URL; gardez donc bien ce bout lorsque vous modifier le host, port et nom de Bdd:
    ...
    private static String url = "jdbc:mysql://localhost:3307/miniprojet_jdbc?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
